        ...
        */
        ...
        protected $_validators = array(
            ...
            "alpha" => array(
                ...
                "message" => "The {0} field can only contain letter"
            ),
            "numeric" => array(
            ...
            "alphanumeric" => array(
                "handler" => "_validateAlphaNumberic",
        ...
        protected function _validateAlphaNumberic($value){
                ...
                if($column["validate"]){
                    ...
                    foreach($validators as $validator){
                        ...
                        if(count($match) > 0){
                            ...
                            $match = StringMethods::split($match[0], ",\s*");
                        ...
                        if(!isset($defined[$function])){
                            ...
                            throw new Excepiton\Validate("The {$function} validator is not defined");
